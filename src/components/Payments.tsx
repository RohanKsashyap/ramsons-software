...
import { Search, Filter, Plus, CreditCard, IndianRupee, Check } from 'lucide-react';
                  ...
                  <tr key={payment._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-900">{payment.paymentMethod?.replace('_', ' ') || ''}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            ...
            ₹do{payments.filter(p => p.paymentMethod === 'CREDIT').reduce((sum, payment) => sum + payment.amount, 0).toFixed(2)}
            </p>
          </div>
        </div>
      </div>
